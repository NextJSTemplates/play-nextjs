...
const SwitchOption = ({
  ...
  return (
    <div className="dark:border-strokedark mx-auto mb-8 flex  flex-col items-center justify-center gap-2.5 rounded-lg border border-stroke bg-gray p-2 dark:border-dark-3 dark:bg-gray-800 md:flex-row ">
      <button
        className={`remove-transiton-all w-full rounded-lg border px-6 py-3 text-base outline-none duration-300 hover:border-dark-3 hover:bg-dark-3 hover:text-white dark:border-transparent dark:hover:bg-dark-3 dark:hover:shadow-none  ${
