                ...
                <ul className="mb-10 flex flex-wrap items-center justify-center gap-5">
                  <li>
                    <Link
                      ...
                      className="remove-transiton inline-flex items-center justify-center rounded-md bg-white px-7 py-[14px] text-center text-base font-medium text-dark shadow-1 duration-300 ease-in-out hover:bg-gray-2"
                    >
                      Download Now
                    </Link>
                  </li>
                  <li>
                    <Link
                      ...
                      target="_blank"
                      className="remove-transiton flex items-center gap-4 rounded-md bg-white/[0.12] px-6 py-[14px] text-base font-medium text-white duration-300 ease-in-out hover:bg-white hover:text-dark"
                    >
                      <svg
