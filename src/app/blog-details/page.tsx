import AuthorQuote from "@/components/Blog/AuthorQuote";
...
export const metadata: Metadata = {
  title:
    "Blog Details | Play Free Next.js Template for Startup and SaaS By TailGrids",
};
              ...
              <div className="-mx-4 flex flex-wrap">
                <div className="w-full px-4 lg:w-8/12">
                  <div>
                    ...
                    <p
                      className="wow fadeInUp mb-8 text-base leading-relaxed text-body-color dark:text-dark-6"
                      data-wow-delay=".1s"
                    >
                    ...
                    <p
                      className="wow fadeInUp mb-10 text-base leading-relaxed text-body-color dark:text-dark-6"
                      data-wow-delay=".1s"
                    >
                      There&apos;s a time and place for everything… including
                      asking for reviews. For instance: you should not asking
                    ...
                    <p
                      className="wow fadeInUp mb-11 text-base leading-relaxed text-body-color dark:text-dark-6"
                      data-wow-delay=".1s"
                    >
                      At quo cetero fastidii. Usu ex ornatus corpora sententiae,
                      vocibus deleniti ut nec. Ut enim eripuit eligendi est, in
